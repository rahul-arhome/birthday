window.ConfettiGenerator=function(e){
    function t(e,t){e||(e=1);
        var i=Math.random()*e;
        return t?Math.floor(i):i
    }
    function i(){
        return{prop:a.props[t(a.props.length,!0)],
            x:t(a.width),
            y:t(a.height),
            radius:t(4)+1,
    ...
    function r(e){
        ...
        switch(n.fillStyle=n.strokeStyle="rgba("+e.color+", "+t+")",n.beginPath(),e.prop){
            ...
            case"triangle":
                n.moveTo(e.x,e.y),
                n.lineTo(e.x+e.angles[0]*a.size,
                e.y+e.angles[1]*a.size),
                n.lineTo(e.x+e.angles[2]*a.size,
            ...
            render:function(){
                ...
                function s(){
                    for(var e=0;e<a.max;e++){
                        ...
                        i.y>a.height&&(l[e]=i,l[e].x=t(a.width,!0),
                        l[e].y=-10)
                    }
                }
                o.width=a.width,
                ...
                clear:function(){
                    ...
                    var e=o.width;o.width=1,o.width=e,clearInterval(a.interval)
                }
            }
        };